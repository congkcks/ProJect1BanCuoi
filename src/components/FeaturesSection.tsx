...
const features = [
  ...
  },
  {
    ...
    title: "Luyện tập Nghe - Nói - Đọc - Viết",
    description: "Thực hành toàn diện 4 kỹ năng với bài tập tương tác và phản hồi tức thì.",
    color: "text-toeic-blue",
    link: "https://congkcks.github.io/pixel-perfect-labs-01876-96953-53253-15-94322/"
  },
  {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="group hover:shadow-card transition-all duration-300 border-0 bg-gradient-feature cursor-pointer"
