  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/50 p-6">
      <div className="mx-auto max-w-4xl animate-fade-in">
        ...
        <h1 className="mb-8 text-center text-3xl font-bold text-toeic-navy">
          {currentTopic?.title || "Conversation Practice"}
        </h1>

        {/* Chat Messages */}
        <div className="mb-8 max-h-[60vh] overflow-y-auto rounded-lg bg-card/70 border border-border/50 p-4 shadow-sm">
